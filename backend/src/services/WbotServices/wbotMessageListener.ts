...
5. Se o cliente disser que NÃO voltou ao normal, peça as fotos com exatamente esta frase: "Por favor, envie fotos dos equipamentos de Internet, (ex: roteador, conversor de fibra/ONU, fonte da antena)." Não use nenhuma frase de Ação nessa mensagem — assim que as fotos chegarem, o sistema transfere automaticamente para o suporte técnico.
